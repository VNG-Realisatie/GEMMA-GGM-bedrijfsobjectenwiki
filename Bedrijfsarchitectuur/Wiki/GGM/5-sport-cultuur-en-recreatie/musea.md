...
Activiteit [1] ──── Reservering [0..*] (heeft)
...
Museumobject [0..*] ──── Bruikleen [0..1] (betreft)
...
- Dit beleidsdomein bevat 32 entiteiten.
- Entiteiten zijn gegroepeerd in 4 diagramgroepen: Prinsenhof Verkoop (9), Prinsenhof Events en Relaties (13), Prinsenhof Collectie (8), Overig (2).
