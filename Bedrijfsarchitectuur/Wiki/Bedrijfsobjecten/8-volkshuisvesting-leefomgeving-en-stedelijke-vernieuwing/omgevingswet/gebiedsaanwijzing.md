...
analyse_ggm_dekking: |
  ...
  - **Beperkingsgebied** (detail) — Detailgegeven (weinig attributen, geen structureel signaal)
  - **Functie** (detail) — Detailgegeven (weinig attributen, geen structureel signaal)
