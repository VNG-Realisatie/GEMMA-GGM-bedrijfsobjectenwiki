...
- Welke entiteiten zijn gevonden als begrip in onderwerpoverzichten (bron-perspectief)?
...
Coverage telt en signaleert; het beoordeelt niet zelf of een entiteit een BO moet worden. Voor beoordeling: verwijs door naar `/assess-element`. Voor de taakveld-brede dekkingsanalyse (met entiteitstype-classificatie): verwijs naar `/entiteitendekking`.
