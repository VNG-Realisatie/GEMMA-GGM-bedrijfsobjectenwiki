...
```
Behandeling [0..*] ──── Behandelsoort [1] (is van soort)
Bijzonderheid [0..*] ──── Bijzonderheidsoort [1] (is van soort)
Client [1] ──── SociaalTeamDossier [0..*] (heeft)
Clientbegeleider [1] ──── SociaalTeamDossier [0..*] (heeft)
Doelstelling [0..*] ──── Doelstellingsoort [1] (is van soort)
SociaalTeamDossier [1] ──── Behandeling [0..*] (heeft behandeling)
SociaalTeamDossier [1] ──── Bijzonderheid [0..*] (heeft bijzonderheid)
SociaalTeamDossier [0..1] ──── Caseaanmelding [0..1] (heeft aanmelding)
SociaalTeamDossier [1] ──── Doelstelling [0..*] (heeft doelstelling)
SociaalTeamDossier [0..*] ──── Relatie [0..*] (heeft betrokkenen)
SociaalTeamDossier [0..*] ──── SociaalteamDossiersoort [1] (heeft soort)
```
