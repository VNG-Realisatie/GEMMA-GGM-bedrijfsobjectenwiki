...
Gemeenten kunnen daarnaast collectief risico's overdragen via een gezamenlijke voorziening. Een concreet voorbeeld is het **Risicobeheerfonds** van de VNG (start 2026): een collectieve opstal-/gebouwenverzekering, voor de helft eigendom van de deelnemende gemeenten en voor de helft van de VNG, zonder winstoogmerk en zonder commissies — eventuele overschotten vloeien terug naar de deelnemers. Na vergunningverlening opereert het fonds als verzekeraar onder prudentieel toezicht van De Nederlandsche Bank (Solvency II). Voor de gemeente is dit géén apart BO: de polis van het Risicobeheerfonds is qua aard een gewone opstal-/inventarisverzekering (zie subtypes), alleen collectief georganiseerd. Onderzocht als kandidaat-BO/actor (2026-09-23), maar te dun gedocumenteerd voor een eigen pagina — geen toetredingsprocedure of deelnemersovereenkomst met voldoende detail beschikbaar.
