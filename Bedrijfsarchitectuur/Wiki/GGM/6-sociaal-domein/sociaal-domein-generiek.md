...
- Dit beleidsdomein bevat 55 Objecttype-entiteiten (+ 17 Enumeraties, 1 diagramhulpobjecten zonder stereotype).
- Entiteiten zijn gegroepeerd in 26 diagramgroepen: AanvraagOfMelding (1), Diagram Basismodel Inkomen (1), Diagram Client en Werkzoekende (2), Diagram Dakloosheid (1), Diagram GGM en Inkomen (2), Diagram Inkomsten (35), Diagram Profiel (6), Diagram Vermogen (6), Gemeente Begrafenissen (1), Gezag (3), Huishouden en Huwelijk (2), Relaties Sociaal Domein tot Kern (4), Relaties tot kern details (1), Schuldhulp Client (2), Schuldhulp Hoofdlijnen (1), Schuldhulpproces (1), Sociaal Domein Beschikking en Voorziening: Domain Objects (3), Sociaal Domein Domain (4), Sociale Relaties (3), Sociale team:Domeinmodel (3), Verplichtingen (2), Vroegsignalering (1), Vroegsignalering Details (1), Vroegsignalering Klein (1), Zorgmelding (1), Zorgmelding Detail (1).
- Er zijn 35 generalisatierelaties aanwezig.
