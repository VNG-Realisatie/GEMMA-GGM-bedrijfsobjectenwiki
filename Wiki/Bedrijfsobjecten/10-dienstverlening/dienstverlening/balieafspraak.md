...
ggm_gemma_definitie: "Balieafspraken zijn afspraken voor een klantcontact. Dit ongeacht of deze werkelijk heeft plaatsgevonden of gaat plaatsvinden, soms liggen deze in de toekomst of is iemand niet op komen dagen, of iets anders waardoor het klantcontact nog niet heeft plaatsgevonden."
...
|---|---|---|---|---|
| [[product-of-dienst]] | → | 0..* | betreft | GGM: Balieafspraak → ProductOfDienst |
| [[zaakdossier]] | → | 0..1 | heeft betrekking op | GGM: Balieafspraak → Zaak |
| [[aanvraag-of-melding]] | → | 0..* | kan uitmonden in (via klantcontact) | GGM: Balieafspraak → Klantcontact → AanvraagOfMelding |
