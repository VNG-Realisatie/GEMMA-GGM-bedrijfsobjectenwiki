...
- [x] arbeidsmigranten
- [x] arbeidsvoorwaarden
- [x] financiele-arbeidsvoorwaarden
- [x] integriteit
- [x] po-beleid
- [x] rechtspositie-politieke-ambtsdragers
- [x] rubriek-arbeidszaken
- [x] werk-voor-arbeidsbeperkten
...
- [x] rsg-basisgegevens-2.02-deel-ii (RSGB 2.02 Deel II: Specificaties, VNG Realisatie/KING, standaard) → `Sources/Standaarden/RSG_Basisgegevens_2.02_deel_II_(in_gebruik).md` — ge-ingest, batch 1 + batch 2

> **Bron gevonden (2026-09-23):** RSGB is zelf de bron voor de RSGBPlus-detailentiteiten — zie `Wiki/Bronsamenvattingen/Standaarden/rsgb-en-informatiemodellen.md`: RSGB neemt de basisregistraties (BAG/BRP/BRK/NHR/WOZ/BGT) bijna volledig over en voegt daar de "door KING toegevoegde" objecttypen aan toe (generalisaties als Benoemd object, Gebouwd object, Subject, Rechtspersoon; gemeentelijke objecten als Overig gebouwd object, Overig Terrein, Gemeente, Wijk, Buurt). Deel I (al ge-ingest) beschrijft alleen het referentiemodel op hoofdlijnen; Deel II bevat de daadwerkelijke gegevenscatalogus (62 objecttypen, attribuut- en relatiesoorten) — exact de ontbrekende detailentiteiten. Zelfde versie (2.02) als de al ge-ingeste Deel I, gepubliceerd op `https://standaarden.vng.nl/Informatiemodellen`. Opgehaald naar `Sources/Standaarden/RSG_Basisgegevens_2.02_deel_II_(in_gebruik).md`.

> **Batch 1 verwerkt (2026-09-23):** bronsamenvatting [[Wiki/Bronsamenvattingen/Standaarden/rsgb-deel-ii-specificaties]]. Van de ~6 generalisaties met exacte GGM-match is alleen **Rechtspersoon** een BO geworden (6/6 criteria, generalisatiewortel voor ~20 domeinrollen in het GGM) — dit herziet een eerdere beslissing bij de NHR-ingest ("te abstract"). Benoemd Object, Gebouwd Object, Benoemd Terrein, Adresseerbaar Object en Subject blijven geen BO (te abstract/geen eigen GGM-entiteit), vastgelegd in de begrippentabel van `Wiki/Onderwerpoverzichten/basisregistraties.md`.

> **Batch 2 verwerkt (2026-09-23):** alle resterende ~28 objecttypen uit RSGB Deel II beoordeeld. 8 nieuwe BO's: Natuurlijk Persoon, Huishouden, Huishoudenlid (naamgeving herzien t.o.v. RSGB-term "Huishoudenrelatie", op verzoek van de gebruiker), Ouderschap (naamgeving herzien t.o.v. RSGB-term "Ouder-kind-relatie", overgenomen uit het al ge-ingeste Logisch Ontwerp BRP), Overig Gebouwd Object, Overig Terrein, WOZ-belang, Gemeentelijke Openbare Ruimte. ~19 begrippen bewust geen BO (referentietabellen, koppelobjecten, abstracte generalisaties, of al gedekt door bestaande BO's/rijen) — volledige beoordeling in `Wiki/Onderwerpoverzichten/basisregistraties.md` §RSGBPlus.

> **Afgehandeld (backlog-checkbox retroactief bijgewerkt):** BGT-catalogus was al ge-ingest, zie `Wiki/Onderwerpoverzichten/basisregistraties.md` en `Wiki/log.md`. Domein Basisregistraties nu volledig afgerond (48 BO's).
