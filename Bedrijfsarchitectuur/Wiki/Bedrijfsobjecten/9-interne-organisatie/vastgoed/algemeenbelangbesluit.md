...
gemma_definitie: "Raadsbesluit op grond van de Wet markt en overheid dat voor aangewezen economische activiteiten verhuur onder de kostprijs mogelijk maakt."
gemma_subtypes: []
relaties:
  - type: associatie
