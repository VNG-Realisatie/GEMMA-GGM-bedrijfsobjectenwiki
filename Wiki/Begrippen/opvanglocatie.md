...
type: begrip
naam: opvanglocatie
definitie: Fysieke locatie waar asielzoekers worden opgevangen, in verschillende vormen en schaalgroottes.
begripstype: object
...
Een opvanglocatie is de fysieke locatie waar asielzoekers worden opgevangen. Er bestaan verschillende typen, elk met een andere taakverdeling tussen COA en gemeente.

## Typen opvanglocaties (gemeentelijk perspectief)

| Type | Omvang | Gemeentelijke rol |
|---|---|---|
| **Regulier azc** | >300 plekken | Onderwijs, openbare orde, jeugdhulp |
...
Het vastgoedproces (verwerving, bouw, inrichting) wordt door het COA uitgevoerd, behalve bij dgo. De wiki beschrijft de opvanglocatie als object waarmee de gemeente te maken krijgt, niet het interne COA-vastgoedproces.
