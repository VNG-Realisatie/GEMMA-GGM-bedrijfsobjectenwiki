...
Gemeentelijke bevoegdheden en instrumenten voor het handhaven van de openbare orde en het bestrijden van ondermijning: van vergunningverlening en gebiedsaanwijzingen tot bestuurlijke sluiting en integriteitstoetsing. Overlapt met VTH (Handhavingsbesluit) en Bestuur (Gemeentewet, burgemeestersbevoegdheden).

## Beoordeling

De oorspronkelijke 10 VNG-bronnen zijn dunne portaalpagina's op strategisch/governance-niveau, zonder concrete objecten (vergelijkbaar met eerdere domeinen als Europa en Internationaal). Eén signaal (BOA) had een directe GGM-match en is verder onderzocht; op verzoek van de gebruiker zijn daarnaast vier rijkere primaire bronnen opgehaald (Wet Bibob, volledige Alcoholwet, Regeling domeinlijsten BOA, VNG Handreiking APV en ondermijning), aangevuld met artikelen uit de al eerder ge-ingeste volledige Gemeentewet (art. 151b, 174, 174a, 174b).

## Begrippentabel

| Begrip | Begripstype | Omschrijving | BO? | Data-object | Reden | Voorbeelden | GGM |
|---|---|---|---|---|---|---|---|
| [[Wiki/Rollen/boa\|BOA]] | rol | Ambtenaar met een specifieke opsporingsbevoegdheid | ❌ | nee | Rol, geen entiteit; vastgelegd als rol-pagina | Boa domein Openbare ruimte, boa domein Milieu | ja |
| [[Wiki/Actoren/landelijk-bureau-bibob\|Landelijk Bureau Bibob]] | actor | Zelfstandig orgaan dat adviseert over de mate van gevaar bij Bibob-toetsen | ❌ | nee | Actor, geen entiteit; vastgelegd als actor-pagina (precedent: Ombudsman, ACOI) | — | nee |
| [[Wiki/Bedrijfsobjecten/1-veiligheid-en-vergunningen/openbare-orde-en-veiligheid/bibob-toets\|Bibob-toets]] | object | Beoordeling van de mate van gevaar op misbruik van een beschikking, opdracht of vastgoedtransactie | ✅ | ja | 6/6 criteria, wettelijk verplicht kader, GGM-hiaat | Bibob-toets bij aanvraag horecavergunning | nee |
| [[Wiki/Bedrijfsobjecten/1-veiligheid-en-vergunningen/openbare-orde-en-veiligheid/preventie-en-handhavingsplan-alcohol\|Preventie- en handhavingsplan alcohol]] | governance-instrument | Vierjaarlijks vast te stellen plan voor preventie alcoholgebruik en handhaving | ✅ | ja | 6/6 criteria, wettelijk verplicht, vaste cyclus, GGM-hiaat | Plan 2026-2030 | nee |
...
| exploitatievergunning (coffeeshop) | object | Vergunning voor het exploiteren van een openbare inrichting (art. 2:28 Apv) | ❌ | ja | Al gedekt door bestaande specialisatie Horecavergunning onder Vergunningen en ontheffingen | — | nee |
...
- [[Wiki/Bronsamenvattingen/Openbare Orde en Veiligheid/wet-bibob-bwbr0013798|Wet Bibob]] — Rijksoverheid: integriteitsbeoordeling vergunningen/subsidies/opdrachten/vastgoedtransacties, Bibob-advies door het Landelijk Bureau Bibob
- [[Wiki/Bronsamenvattingen/Openbare Orde en Veiligheid/alcoholwet-wettekst|Alcoholwet — wettekst]] — Rijksoverheid: verordeningsbevoegdheden, preventie- en handhavingsplan (art. 43a), alcoholoverlastgebied (art. 25f)
...
- [aanpak-radicalisering.md](../../Sources/Onderwerpen/Openbare%20Orde%20en%20Veiligheid/Niet-relevant/aanpak-radicalisering.md)
- [alcoholwet.md](../../Sources/Onderwerpen/Openbare%20Orde%20en%20Veiligheid/Niet-relevant/alcoholwet.md) — dunne VNG-samenvatting, vervangen door de volledige wettekst
- [jaarwisseling-en-vuurwerk.md](../../Sources/Onderwerpen/Openbare%20Orde%20en%20Veiligheid/Niet-relevant/jaarwisseling-en-vuurwerk.md)
...
- ~~**Coffeeshop**~~ — **Opgelost (2026-09-23):** Coffeeshopbeleid 2024 (Vijfheerenlanden) opgehaald → 1 nieuw BO: [[Wiki/Bedrijfsobjecten/1-veiligheid-en-vergunningen/openbare-orde-en-veiligheid/gedoogverklaring|Gedoogverklaring]]. Exploitatievergunning blijft gedekt door bestaande specialisatie Horecavergunning.
...
- ~~**Model-APV-vergunningplichten**~~ — **Opgelost (2026-09-23):** autoverhuur, glazenwassers, spyshops en woningverhuur/-bemiddeling zijn qua vorm identiek aan de al bestaande specialisaties (Standplaatsvergunning, Horecavergunning e.a.) — als 4 nieuwe specialisaties toegevoegd aan het generieke BO [[Vergunningen en ontheffingen]], geen hiaat. Evenementen en exploitatie openbare inrichting waren al gedekt (Evenementenvergunning resp. Horecavergunning).
