...
|---|---|---|---|---|---|---|
| [[Wiki/Bedrijfsobjecten/8-volkshuisvesting-leefomgeving/beheer-openbare-ruimte/boom\|Boom]] | object | Individueel geregistreerd houtachtig gewas, beheerd door de gemeente | ✅ | 6/6 criteria, 110.000+ individueel geregistreerd, eigen levenscyclus, exact GGM-match | Straatboom, parkboom, monumentale boom | ja |
| monumentale boom | classificatie | Boom ≥80 jaar of anderszins bijzonder aangemerkt | ❌ | Status/classificatie van Boom (beleidsstatus-attribuut in GGM) | Boom van 275 jaar in de oude Hortus | nee |
| bomenstructuur | structuur | Samenhangende stedelijke structuur van boomlijnen en -vlakken | ❌ | Ruimtelijk planningsconcept, niet individueel identificeerbaar of telbaar | Accessen, stadslanen, grachten | nee |
| bomenparagraaf | instrument | Verplichte sectie in ruimtelijke plannen over gevolgen voor bomen | ❌ | Governance-instrument, document-onderdeel | Bomenparagraaf bij rioleringsplan | nee |
| kapvergunning | instrument | Vergunning voor het vellen van bomen | ❌ | Specialisatie van Omgevingsvergunning (al in GGM), apart domein | Kapvergunning eik binnenstad | nee |
| herplantplicht | regel | Verplichting tot herplant bij kap (APV 2018) | ❌ | Regel/voorwaarde, attribuut van Boom in GGM | Herplant 3 linden na kap | nee |
| groeiplaats | eigenschap | Fysieke standplaats met bodemkenmerken en ruimte-eisen | ❌ | Eigenschap van Boom (standplaats-attributen in GGM) | Bomenzand in verharding | nee |
| VTA-inspectie | proces | Visual Tree Assessment, systematische beoordeling conditie en veiligheid | ❌ | Procesactiviteit, valt onder GGM-entiteit Inspectie | Halfjaarlijkse veldbeoordeling | nee |
| [[Wiki/Bedrijfsobjecten/8-volkshuisvesting-leefomgeving/beheer-openbare-ruimte/groenobject\|Groenobject]] | object | Afgebakend stuk terrein met vegetatie, beheerd als onderdeel van de groenstructuur | ✅ | 6/6 criteria, duizenden geregistreerd, eigen levenscyclus, exact GGM-match | Stadspark, plantsoen, gazon, haag | ja |
| [[Wiki/Bedrijfsobjecten/8-volkshuisvesting-leefomgeving/beheer-openbare-ruimte/faunapassage\|Faunapassage]] | object | Fysieke voorziening voor diermigratie over/onder infrastructuurbarrières | ✅ | 6/6 criteria, tientallen geïnventariseerd, eigen levenscyclus, sterk GGM-match (Ecoduct) | Faunatunnel, ecoduct, loopplank | ja |
| groenstructuur | structuur | Netwerk van groengebieden en groene verbindingen, vastgelegd op de visiekaart | ❌ | Ruimtelijk planningsconcept, classificatie van gebieden, geen zelfstandig object | Stedelijke groenstructuur Utrecht | nee |
| visiekaart | instrument | Beleidskaart die vastlegt welke gebieden tot de groenstructuur behoren | ❌ | Governance-instrument, geen eigen levenscyclus los van het beleid | Visiekaart groenstructuur 2030 | nee |
...
| beschermde soort | classificatie | Plant- of diersoort op de Utrechtse soortenlijst of Wet Natuurbescherming | ❌ | Classificatie/referentielijst, geen gemeentelijk concept met eigen levenscyclus | Tongvaren, ringslang, steenuil | nee |
| wijkgroenplan | instrument | Plan per wijk voor verbetering van groenvoorzieningen | ❌ | Beleidsinstrument, geen zelfstandig bestaan los van het groenbeleid | Wijkgroenplan Overvecht | nee |
...
| BInG-toets | proces | Integrale beoordeling van inrichting, gebruik, veiligheid en onderhoud bij projecten | ❌ | Governance-proces, geen zelfstandig concept met eigen levenscyclus | Toets herinrichting Mariaplaats | nee |
| CROW-beeldkwaliteit | meetstandaard | Meetstandaard met 5 niveaus (A+ t/m D) voor kwaliteit openbare ruimte | ❌ | Externe standaard, classificatieschaal, geen gemeentelijk concept | CROW-niveau B voor verhardingen | nee |
| ontwikkelend beheer | concept | Beheervisie: vervanging combineren met verbetering op klimaat, gezondheid, circulariteit | ❌ | Beleidsconcept, geen zelfstandig bestaan of eigen levenscyclus | Herinrichting met vergroening en 30 km/u | nee |
...
| speelbuurt | analyse-eenheid | Gebied begrensd door barrières, analyse-eenheid voor speelruimtenorm | ❌ | Analyse-eenheid, geen eigen levenscyclus of relaties | Speelbuurt Utrecht West | nee |
