...
Het GGM dekt niet alle gemeentelijke domeinen. Uit de [[vng-rubrieken-mapping]] blijkt dat domeinen als Belastingen, Energietransitie, Openbare gezondheid en Risicobeheer hiaten hebben. Voor deze domeinen kan het bedrijfsobjectenmodel top-down worden opgebouwd vanuit beleidsbronnen en procesbeschrijvingen, als aanvulling op het GGM. Zodra het GGM deze domeinen uitwerkt, kunnen de bottom-up entiteiten worden gekoppeld aan de top-down bedrijfsobjecten.
...
Uit de systematische mapping van VNG-beleidsbegrippen op het GGM is een voorspelbaar patroon gebleken (zie [[ggm-dekkingspatroon]]). Dit patroon maakt het mogelijk om voor nieuwe domeinen vooraf in te schatten waar het GGM zal dekken en waar aanvulling nodig is:
...
- Wiki-analyses: [[ggm-dekkingspatroon]], [[ggm-hiaten-belastingendomein]], [[vng-rubrieken-mapping]]
