...
3. Bepaal het domein — volg de indelingsregels in CLAUDE.md § "Bronnen toevoegen".
4. Verplaats naar `Sources/{domein}/{beschrijvende-slug}.md` (lowercase, kebab-case, max 60 tekens).
